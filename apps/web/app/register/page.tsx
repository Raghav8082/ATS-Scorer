      ...
      <div className="w-full max-w-md relative z-10 my-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-1.5 text-center">
            Start evaluating candidate resumes with vector accuracy
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex items-start gap-2.5 mt-1">
              <input
                ...
                className="w-4 h-4 mt-0.5 rounded bg-[#14141a] border-white/20 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-0 focus:ring-offset-transparent cursor-pointer"
              />
